...
public class IntelliNEW {
    ...
    public static void JehoTian() {
        ...
        // Display the note
        JOptionPane.showMessageDialog(null, "NOTE: 1 IS EQUIVALENT TO 1000 AND ABOVE 100000 IS ONLY 100000");
    ...
    public static void JehoTiann() {
        ...
        while (attempts < 3) {
            if (otp1 == null || transaction == null || otp1.isEmpty() || transaction.isEmpty()) {
                ...
                jehoReceipt("Customer", validAmount, otp, jcode);
                break;
